                        ...
                        <Card className={isAlert ? 'border-red-200 dark:border-red-800/60' : ''}>
                          <div className="p-2 sm:p-2.5 flex items-center gap-1.5 sm:gap-2" dir="rtl">
                            <div className="flex-1 min-w-0 text-right">
                              <p className="font-medium text-sm leading-tight flex items-baseline gap-1 justify-end"><span className="text-sm text-muted-foreground flex-shrink-0">{i + 1}.</span><span className="inline-block min-w-0 truncate">{formatStudentName(student)}</span></p>
                              {current?.note && (
