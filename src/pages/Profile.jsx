...
export default function Profile({ user, role, onRoleChange, themePreference, onThemePreferenceChange }) {
  ...
  const [form, setForm] = useState({
    ...
    profile_photo_position: Number(user?.profile_photo_position ?? 20),
    profile_photo_zoom: Number(user?.profile_photo_zoom ?? 1),
  ...
  const handleSave = async (event) => {
    ...
    const data = {
      ...
      profile_photo_position: Number(form.profile_photo_position ?? 20),
      profile_photo_zoom: Number(form.profile_photo_zoom ?? 1),
