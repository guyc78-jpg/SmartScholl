...
const statusConfig = {
  ...
  'נוכח/ת': 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400',
  'נעדר': 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400',
  'נעדר/ת': 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400',
  'מאחר': 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400',
  'מאחר/ת': 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400',
  ...
  'שוחרר/ה': 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
  // Discipline
